      ...
      <div className="space-y-5">
        ...
        <div className="card p-6">
          ...
          <p className="text-sm text-warm-muted mb-3 leading-relaxed">
            ...
            機能があります。投稿された写真にはグッズに印字された公式イラスト等が写り込む場合があります。投稿は外部フォームサービス（Tally）を通じて受け付けています。承認された投稿のみを当サイトのデータとして保持し、未承認の投稿が当サイトのリポジトリや公開ページに掲載されることは一切ありません。
          </p>
          <ul className="space-y-3">
            {[
              "投稿はすべて管理者が内容を確認した上で公開する承認制（未承認の内容は一切公開されません）",
