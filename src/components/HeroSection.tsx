...
export default function HeroSection({ todayCount, totalPosts, lastUpdated }: HeroSectionProps) {
  ...
  return (
    <section className="relative overflow-hidden rounded-4xl bg-gradient-to-br from-mint-100 via-cream-100 to-lavender-100 border border-warm-border px-6 py-10 mb-8 animate-fade-in-up">
      {/* 装飾 */}
      ...
      <div className="relative">
        ...
        <p className="text-sm text-warm-muted mb-6 animate-fade-in-up" style={{ animationDelay: "180ms" }}>
          公式X（旧Twitter）の情報を整理・検索しやすくする非公式アーカイブ
        </p>

        <div className="flex flex-wrap gap-4">
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl px-4 py-3 border border-white/80 shadow-soft animate-fade-in-up" style={{ animationDelay: "240ms" }}>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl px-4 py-3 border border-white/80 shadow-soft animate-fade-in-up" style={{ animationDelay: "300ms" }}>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl px-4 py-3 border border-white/80 shadow-soft animate-fade-in-up" style={{ animationDelay: "360ms" }}>
